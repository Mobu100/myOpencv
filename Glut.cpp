...
namespace nl_uu_science_gmt
{
    ...
    {
        	//initialize the ArcBall for scene rotation
        //debug point:OpenGL calls after glutCreateWindow.
...
//        That's bad form for an OpenGL implementation - most implementations will normally just have any OpenGL functions return immediately if there's not a current context.
        ...
        glutInitDisplayMode(GLUT_RGB | GLUT_DOUBLE | GLUT_DEPTH| GLUT_MULTISAMPLE| GLUT_3_2_CORE_PROFILE);
        arcball_reset();
