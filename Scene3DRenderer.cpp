...
//        //BackgroundSubstractor MOG
//        Mat fgMaskMOG,foreground;
//        Ptr<BackgroundSubtractor> pMOG;
//        Mat element = getStructuringElement(MORPH_RECT, Size(7, 7), Point(3,3) );
//        //creat background substractor objects
//        pMOG =new BackgroundSubtractorMOG2(300,32,true);
//        // background substraction
//        pMOG->operator()(camera->getFrame(), fgMaskMOG);
//        //processing
//        morphologyEx(fgMaskMOG, foreground, CV_MOP_CLOSE, element);
//        //remove shadow
