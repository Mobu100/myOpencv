...
#ifndef Scene3DRenderer_hpp
#define Scene3DRenderer_hpp
...
namespace nl_uu_science_gmt
{
    ...
    class Scene3DRenderer
    {
        ...
        const vector<Camera*> &m_cameras;  // Reference to camera's vector
        ...
        Size m_board_size;                   // WxH checkerboard
        ...
        vector<vector<Point3i*> > m_floor_grid;
